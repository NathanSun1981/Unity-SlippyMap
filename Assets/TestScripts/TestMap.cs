...
public class TestMap : MonoBehaviour
{
    ...
    public bool isMapRotateLocked { get; set;}
    ...
    public void OnMapLockerClick()
    {
        isMapRotateLocked = true;
    }

    public void OnMapUnLockerClick()
    {
        isMapRotateLocked = false;
    }
    ...
    private void pointersPressedHandler(object sender, PointerEventArgs e)
    {
        ...
        if (activeCount == 0)
        {
            ...
            if (Physics.Raycast(ray, out hitInfo))
            {
                if (!RectTransformUtility.RectangleContainsScreenPoint(invPanel, Input.mousePosition) && hitInfo.collider.gameObject.name.Contains("tile"))
                {
                    drag = true;
